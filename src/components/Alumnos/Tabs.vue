                            ...
                            <v-layout wrap>
                                <v-flex md6 xs12>    
                                     <v-text-field
                                        ...
                                        v-model="form.numerocontratro"
                                        hint="Ejemplo: 0012345"
                                        persistent-hint
                                        outline
                                    ></v-text-field>
                                </v-flex>
                                ...
                                <v-flex md6 xs12>
                                    <v-text-field
                                        label="Nombres del Comprador"
                                        v-model="form.nombrecomprador"
                                        hint="Ejemplo: Jesus Enmanuel"
                                        persistent-hint
                                        outline
                                    ></v-text-field>
                                </v-flex>
                                <v-flex md6 xs12>
                                    <v-text-field
                                        ...
                                        v-model="form.apellidocomprador"
                                        hint="Ejemplo: Huayhualla Andrade"
                                        persistent-hint
                                        outline
                                    ></v-text-field>
                                </v-flex>
                                ...
                                <v-flex md6 xs12>
                                    <v-text-field
                                        ...
                                        hint="Ejemplo: av. sin nombre 123, Pueblo Libre"
                                        persistent-hint
                                        outline
                                    ></v-text-field>
                                </v-flex>
                                ...
                                <div v-if="form.modopago=='En cuotas'">
                                    <v-flex md6 xs12>
                                        <v-text-field
                                            label="Número de cuotas"
                                            v-model="form.numerocuota"
                                            hint="Ejemplo: "
                                            persistent-hint
                                            outline
                                        ></v-text-field>
                                    ...
                                    <v-flex md6 xs12>
                                        <v-text-field
                                            label="Costo por cuota"
                                            v-model="form.costocuota"
                                            hint="Ejemplo: "
                                            persistent-hint
                                            outline
                                        ></v-text-field>
...
export default {
  ...
  data() {
    return {
        ...
        modospago: [
            { text: 'Seleccione el modo de pago', value: null },
            'En cuotas', 'Pago contado'
        ],
        numerocuotas: [
            { text: 'Seleccione el número de cuotas', value: null },
            '1', '2', '3'
        ],
        vendedores: [
            { text: 'Seleccione el vendedor que realizó el contrato', value: null },
        ],
        show: true,
        formgrupal:{
            usuarios:'',
